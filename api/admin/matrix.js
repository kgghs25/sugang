...
const SEM_COURSES = {
  s21: ["주제 탐구 독서","기하","세계 문화와 영어","세계시민과 지리","현대사회와 윤리","법과 사회","동아시아 역사 기행","금융과 경제생활","물리학","화학","지구과학","세포와 물질대사","생활과학 탐구","데이터 과학","스페인어","일본어","음악 연주와 창작","미술 창작"],
  s22: ["문학과 영상","인공지능 수학","영미 문학 읽기","사회와 문화","세계사","정치","윤리문제 탐구","기후변화와 지속가능한 세계","생명과학","역학과 에너지","물질과 에너지","지구시스템과학","융합과학 탐구","아동발달과 부모","정보과학","스페인어 회화","일본어 회화","음악 감상과 비평","미술 감상과 비평"],
  s31: ["독서 토론과 글쓰기","미적분Ⅱ","수학과제 탐구","심화 영어","윤리와 사상","경제","한국지리 탐구","사회문제 탐구","역사로 탐구하는 현대 세계","전자기와 양자","화학 반응의 세계","생물의 유전","행성우주과학","기후변화와 환경생태","지식 재산 일반","인공지능 기초","스페인어권 문화","일본 문화","음악과 미디어","미술과 매체"],
  s32: ["매체 의사소통","언어생활 탐구","수학과 문화","실용 통계","심화 영어 독해와 작문","미디어 영어","국제 관계의 이해","인문학과 윤리","도시의 미래 탐구","여행지리","과학의 역사와 문화","창의 공학 설계","소프트웨어와 생활","심화 스페인어","심화 일본어","음악콘텐츠 제작 기초","조형"]
};
